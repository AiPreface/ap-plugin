...
export class example extends plugin {
  ...
  async ChangeBackground(e) {
    ...
    var base64 = Buffer.from(img.data, "binary").toString("base64");
  ...
  async PartialRedraw(e) {
    ...
    var BlackImgBase64 = Buffer.from(BlackImgBuffer.data, "binary").toString(
      "base64"
    );
    let OriginImgBuffer = await axios.get(OriginImg, {
      responseType: "arraybuffer",
    });
    var OriginImgBase64 = Buffer.from(OriginImgBuffer.data, "binary").toString(
      "base64"
    );
