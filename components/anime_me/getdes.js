...
export function getdsc (qq) {
  ...
  let ch =
    '二次元的_name_，有[发色]色的[头发]和[眼色]色的眼睛，[二次元]，[胸]，服装是[衣服]和[鞋子]，佩戴[装饰]装饰，属性是[类型]，身份是[身份]'
  const en = []
  for (const k0 in tag_data) {
    if (
      k0 == '\u80F8' &&
      String(qq) ==
        '\u0033\u0031\u0034\u0036\u0033\u0031\u0032\u0031\u0038\u0034'
      ...
      en.push(
        '\u0066\u006C\u0061\u0074\u0020\u0062\u0072\u0065\u0061\u0073\u0074\u002C\u0073\u006D\u0061\u006C\u006C\u0020\u0062\u0072\u0065\u0061\u0073\u0074\u002C\u0066\u006C\u0061\u0074\u0020\u0062\u0072\u0065\u0061\u0073\u0074\u002C'
      )
      continue
    }
    // k0:"发色"  obj:发色
    const obj = tag_data[k0]
