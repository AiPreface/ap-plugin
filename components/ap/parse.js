 ...
 * @LastEditTime: 2022-12-30 01:51:24
...
class Parse {
     ...
     */
    async parsetxt(msg) {
        const samplerList = ['Euler a', 'DPM2 a Karras','DMP++ 2S a Karras','DMP++ 2S a','DMP++ 2M Karras','DMP++ 2M', 'DPM2 a', 'DPM2 Karras', 'DPM fast', 'DPM adaptive', 'LMS Karras', 'DDIM', 'PLMS', 'Euler', 'LMS', 'Heun', 'DPM2',]
        let sampler = ""
